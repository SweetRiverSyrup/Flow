...
module.exports = {
    ...
    "flag": function(custom){
        //{type: [win, warn, error, danger, info], title: String, text: String, ref:[Only for Type=error][id of element], to: String[Element ID/Hub]}
        ...
        switch (custom.type){
            ...
            case "error":
                ...
                var $newerFlag = createFlag("danger", custom.text, custom.title, custom.ref);
