...
function addFlag(type, text, custom){
    ...
    var flag = flagCenter.find(".form-flag-init");
    ...
    switch (type){
        ...
        case "error":
            ...
            var flagTwo = newFlag.clone();
            flagTwo.find(".form-flag-title").text("Error!");
            flagTwo.find(".form-flag-text").html("The above field was not filled in properly or it was left blank.");
            var errRef = "#" + custom.id;
